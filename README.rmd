...
Using linear discriminant analysis (LDA) we created a baseline model with predictive accuracy
of 70%. This did not match the original researchers' benchmark of 78.5%.
